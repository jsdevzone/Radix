 ...
 */
 export class RequestQuotation extends React.Component {
     /**
      * @constructor
      */
     constructor(args) {
                 ...
                 <div style={{padding: 10, margin: 5, border: 'solid 1px #D1D1D1'}}>
                      <div style={{display: 'table'}}>
                          <div style={{marginBottom: 6, display:'table-cell'}}>
                              <TextField label="Quotation No" width={200} placeholder="0001" />
                          </div>
                          ...
                          <div style={{marginBottom: 6, display:'table-cell', paddingLeft: 10}}>
                          <TextField label="MR NUmber" width={300} labelWidth={70} placeholder="0001" />
                          </div>
                      </div>
                        <DetailPanel>
